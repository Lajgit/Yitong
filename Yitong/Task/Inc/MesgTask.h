...
#define MesgEvent_RemainingEgg (1u << 2)            // 发送扭蛋剩余待出数量
#define MesgEvent_EggOutputTimeout (1u << 3)        // 发送扭蛋输出超时
...
#define MesgEvent_RemainingSteelBall (1u << 17)     // 发送钢珠剩余待出数量
#define MesgEvent_SteelBallOutputTimeout (1u << 18) // 发送钢珠输出超时
